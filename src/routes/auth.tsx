    ...
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center px-4 py-12 bg-background">
      <div className="w-full max-w-md bg-card border border-border rounded-2xl shadow-sm p-6 sm:p-8">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-muted-foreground mt-2">
            Welcome — sign in to manage your wallet &amp; orders.
          </p>
        </div>
        ...
        <p className="text-xs text-center text-muted-foreground mt-5">
          ...
          <Link to="/about" className="text-brand-orange hover:underline">
            Terms
          </Link>
          .
        </p>
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-4">
      ...
      <button
        type="button"
        onClick={onForgot}
        className="text-xs text-brand-orange hover:underline w-full text-center"
      >
        Forgot password?
      </button>
    </form>
    ...
    <Button type="button" variant="outline" onClick={onClick} disabled={loading} className="w-full">
      {loading ? (
        ...
        <svg className="w-4 h-4 mr-2" viewBox="0 0 24 24">
          ...
          <path
            fill="#EA4335"
            d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.47 3.47 2.18 7.07l3.66 2.83C6.71 7.31 9.14 5.38 12 5.38z"
          />
        </svg>
      )}
