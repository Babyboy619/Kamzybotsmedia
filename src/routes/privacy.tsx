        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-8 p-4 rounded-xl bg-green-50 border border-green-200">
            ...
            <p className="text-sm text-muted-foreground">
              Kamzybot's Media is committed to protecting your personal information. This Privacy
          ...
          <div className="prose prose-slate max-w-none space-y-8">
            <Section title="1. Who We Are">
              <p>
                Kamzybot's Media ("we", "us", or "our") operates a digital solutions and creative
                services platform where users can access professional social media growth strategies
                and related digital services. We are committed to processing your personal data
            ...
            <Section title="2. Information We Collect">
              ...
              <p>
                <strong>Transaction and Payment Data:</strong>
              </p>
              <ul>
                <li>Wallet balance and transaction history</li>
                <li>Payment references and amounts (NeuraPay)</li>
              ...
              <p>
                We do not collect full card numbers or private keys. Payment processing is handled
                by NeuraPay and governed by its privacy policy.
              </p>
            </Section>
            ...
            <Section title="3. How We Use Your Information">
              ...
              <p>
                We do <strong>not</strong> sell your personal data to third parties, nor use it for
            ...
            <Section title="4. Legal Basis for Processing">
              ...
              <ul>
                <li>
                  <strong>Contract performance</strong> — to fulfil your orders and deliver products
                </li>
                <li>
                  <strong>Legitimate interests</strong> — to operate, maintain, and secure the
                  Platform
                </li>
                <li>
                  <strong>Legal obligation</strong> — to comply with applicable Nigerian and
                  international laws
                </li>
                <li>
                  <strong>Consent</strong> — for any optional communications you opt into
                </li>
              </ul>
            </Section>
            ...
            <Section title="5. Third-Party Services">
              ...
              <ul>
                <li>
                  ...
                  stored on EU/US servers with encryption at rest and in transit.
                </li>
                <li>
                  <strong>NeuraPay</strong> — payment processing for Nigerian Naira transactions.
                  Governed by the provider's privacy policy.
                </li>
                <li>
                  <strong>Cloudflare</strong> — CDN, DDoS protection, and edge functions. Governed
                  by{" "}
                  <a
              ...
              <p>
                Each third-party service processes only the data necessary to provide their specific
                service to us.
              </p>
            </Section>
            ...
            <Section title="6. Data Retention">
              ...
              <ul>
                <li>
                  Account data: retained for the lifetime of your account, then deleted within 30
                  days of account closure
                </li>
                <li>
                  Transaction and order records: retained for 7 years for financial compliance
                  purposes
                </li>
                <li>Activity logs: retained for 12 months for security purposes</li>
              </ul>
              <p>
                Delivered credential data (stored in order items) is retained permanently as your
                purchase receipt.
              </p>
            </Section>
            ...
            <Section title="7. Data Security">
              <p>
                ...
                personal data against accidental loss, destruction, alteration, and unauthorised
                access or disclosure. These measures include:
              </p>
              <ul>
                <li>TLS/HTTPS encryption for all data in transit</li>
                <li>
                  Row-Level Security (RLS) on all database tables — users can only access their own
                  data
                </li>
              ...
              <p>
                Despite these measures, no system is 100% secure. If you believe your account has
            ...
            <Section title="8. Cookies and Tracking">
              ...
              <p>
                We do not use third-party advertising cookies or tracking pixels. You may disable
                cookies in your browser settings, but this will prevent you from logging in to the
                Platform.
              </p>
            </Section>
            ...
            <Section title="9. Your Rights">
              <p>
                Under the Nigeria Data Protection Act (NDPA) and related regulations, you have the
                right to:
              </p>
              <ul>
                <li>
              ...
              <p>
                To exercise any of these rights, contact us at the details below. We will respond
                within 30 days.
              </p>
            </Section>
            ...
            <Section title="10. Children's Privacy">
              <p>
                ...
                knowingly collect personal data from minors. If we discover that a minor has
            ...
            <Section title="11. International Data Transfers">
              <p>
                Your data may be processed in countries outside Nigeria (including the United States
                and European Union) by our third-party service providers. We ensure that adequate
            ...
            <Section title="12. Changes to This Policy">
              <p>
                ...
                you via email or a prominent notice on the Platform. Your continued use of the
            ...
            <Section title="13. Contact Us">
              ...
              <ul>
                <li>
                  <strong>Email:</strong> kamzybotsmedia@gmail.com
                </li>
                <li>
